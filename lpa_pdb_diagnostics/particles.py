        ...
        for quantity in self.quantities:
            if quantity == "PID":
                if pdb_present:
                    ...
                    self.ssn = ts.get_particle(var_list="ssn",
            ...
            if quantity == "Weight":
                if pdb_present:
                    ...
                    self.w = ts.get_particle(var_list=["w"],
                        iteration = self.it,  species=self.species)[0]
            ...
            if quantity == "Position":
                if pdb_present:
                    ...
                    self.x, self.y, self.z = np.array(ts.get_particle(
                    var_list=["x","y", "z"], iteration = self.it,
            ...
            if quantity == "Momentum":
                if pdb_present:
                    ...
                    self.ux, self.uy, self.uz = np.array(ts.get_particle(
                    var_list=["ux","uy", "uz"],
                    iteration = self.it,  species=self.species))
            ...
            if quantity == "E":
                if pdb_present:
                    ...
                    self.ex, self.ey, self.ez = np.array(ts.get_particle(
                    var_list=["ex","ey", "ez"], iteration = self.it,
                    species=self.species))
            ...
            if quantity == "B":
                if pdb_present:
                    ...
                    self.bx, self.by, self.bz = np.array(ts.get_particle(
                    var_list=["bx","by", "bz"], iteration = self.it,
                    species=self.species))
